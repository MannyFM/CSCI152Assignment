...
public interface FileSystemInterface {
  ...
  /**
   * Provides a listing of all documents and folders on your file system, in the
   * form of full pathnames starting from the root. The pathnames will be listed
   * in the queue in the order defined by the rules:
   *
